...
import * as indianStates from './indian_states_paths.js';
import * as canadianProvinces from './canadian_provinces_paths.js';
import * as australianStates from './australian_states_paths.js';
import * as mexicanStates from './mexican_states_paths.js';
import * as brazilianStates from './brazilian_states_paths.js';
import * as chineseProvinces from './chinese_provinces_paths.js';
...
export const CATEGORIES = {
	...
	9: {
		...
		key: 'indian_states',
		viewBox: '0 0 1000 1000',
		shapes: buildShapes(indianStates)
	},
	10: {
		id: 10,
		key: 'canadian_provinces',
		viewBox: '0 0 1000 1000',
		shapes: buildShapes(canadianProvinces)
	},
	11: {
		id: 11,
		key: 'australian_states',
		viewBox: '0 0 1000 1000',
		shapes: buildShapes(australianStates)
	},
	12: {
		id: 12,
		key: 'mexican_states',
		viewBox: '0 0 1000 1000',
		shapes: buildShapes(mexicanStates)
	},
	13: {
		id: 13,
		key: 'brazilian_states',
		viewBox: '0 0 1000 1000',
		shapes: buildShapes(brazilianStates)
	},
	14: {
		id: 14,
		key: 'chinese_provinces',
		viewBox: '0 0 1000 1000',
		shapes: buildShapes(chineseProvinces)
	},
	4: {
		id: 4,
		key: 'africa',
