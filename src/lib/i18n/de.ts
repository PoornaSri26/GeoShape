...
export const de: Partial<Record<MessageKey, string>> = {
	...
	'identity.namePlaceholderHint': 'Dieser Name wird anderen Spielern angezeigt.',
	...
	'category.8': 'Welt',
	'category.9': 'Indische Bundesstaaten',
	'category.10': 'Kanadische Provinzen',
	'category.11': 'Australische Bundesstaaten',
	'category.12': 'Mexikanische Bundesstaaten',
	'category.13': 'Brasilianische Bundesstaaten',
	'category.14': 'Chinesische Provinzen',
	...
	'hero.guess': 'Errate das Land',
	'hero.whatIsThis': 'Was ist das?',
	'hero.watchOutline': 'Die Umrandung erscheint gleich…',
	'hero.isItFrance': 'Ist es… Frankreich?',
	'hero.orMaybe': 'Oder vielleicht… Brasilien?',
	'hero.gettingCloser': 'Schon näher…',

	'nav.review': '🧠 Deck & Karte',
	'review.title': 'Karteikarten & Fortschrittskarte',
	'review.subtitle': 'Wiederhole verpasste Orte und sieh wie sich deine Karte grün füllt.',
	'review.tabMap': '🗺️ Kartenfortschritt',
	'review.tabDeck': '📚 Verpasste Orte',
	'review.tabSession': '⚡ SRS-Lerneinheit',
	'review.tabFamilies': '🧩 Formfamilien & Doppelgänger',
	'review.dueNow': 'Fällig',
	'review.mastered': 'Gemeistert',
	'review.learning': 'In Bearbeitung',
	'review.totalPlaces': 'Gesamte Orte',
	'review.startSession': 'Lerneinheit starten ({count} fällig)',
	'review.practiceAll': 'Gesamten Stapel üben',
	'review.cleanMastered': 'Gemeisterte aufräumen',
	'review.stage': 'Stufe {stage}',
	'review.again': 'Nochmal (<1 Min)',
	'review.hard': 'Schwer',
	'review.good': 'Gut',
	'review.easy': 'Einfach',
	'review.timesMissed': 'Verpasst {count}x',
	'review.accuracy': 'Genauigkeit',
	'review.nextDue': 'Nächste Fälligkeit',
	'review.dueIn': 'In {time}',
	'review.addPlace': '+ Zum Stapel',
	'review.addedToDeck': 'Zum Stapel hinzugefügt!',
	'map.unexplored': 'Unerforscht',
	'map.mastered': 'Gemeistert',
	'map.learning': 'Am Lernen',
	'map.needsReview': 'Wiederholung fällig',
	'map.completion': '{percent}% Gemeistert'
};
