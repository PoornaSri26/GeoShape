export const en = {
	...
	'identity.namePlaceholderHint': 'This name will be shown to other players.',
	...
	'category.8': 'World',
	'category.9': 'Indian states',
	'category.10': 'Canadian provinces',
	'category.11': 'Australian states',
	'category.12': 'Mexican states',
	'category.13': 'Brazilian states',
	'category.14': 'Chinese provinces',
	...
	'hero.guess': 'Guess the Country',
	'hero.whatIsThis': 'What is this place?',
	'hero.watchOutline': 'Watch the outline appear…',
	'hero.isItFrance': 'Is it… France?',
	'hero.orMaybe': 'Or maybe… Brazil?',
	'hero.gettingCloser': 'Getting closer…',

	'nav.review': '🧠 Deck & Map',
	'review.title': 'Spaced Repetition & Progress Tracker',
	'review.subtitle': 'Review missed places and watch your map fill up as you master each country & state.',
	'review.tabMap': '🗺️ Map Progress',
	'review.tabDeck': '📚 Missed Deck',
	'review.tabSession': '⚡ SRS Session',
	'review.tabFamilies': '🧩 Shape Families',
	'review.dueNow': 'Due now',
	'review.mastered': 'Mastered',
	'review.learning': 'Learning',
	'review.totalPlaces': 'Total places',
	'review.startSession': 'Start Review ({count} due)',
	'review.practiceAll': 'Practice All Deck',
	'review.cleanMastered': 'Clear Mastered',
	'review.stage': 'Stage {stage}',
	'review.again': 'Again (<1 min)',
	'review.hard': 'Hard',
	'review.good': 'Good',
	'review.easy': 'Easy',
	'review.timesMissed': 'Missed {count}x',
	'review.accuracy': 'Accuracy',
	'review.nextDue': 'Next due',
	'review.dueIn': 'In {time}',
	'review.addPlace': '+ Add to Deck',
	'review.addedToDeck': 'Added to Missed Deck!',
	'map.unexplored': 'Unexplored',
	'map.mastered': 'Mastered',
	'map.learning': 'Learning',
	'map.needsReview': 'Needs Review',
	'map.completion': '{percent}% Mastered'
} as const;
